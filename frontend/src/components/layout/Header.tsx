        ...
        <div className="px-4 py-6 space-y-1">
          ...
          <div className="pt-4 border-t border-ink-100 space-y-2">
            ...
            <a
              ...
              className="flex items-center justify-center gap-2 px-4 py-3 rounded-xl border border-ink-200 text-base font-semibold text-ink-900 hover:bg-ink-50 transition-colors"
              onClick={() => setMobileOpen(false)}
            >
